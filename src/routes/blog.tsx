...
export const Route = createFileRoute("/blog")({
  head: () => ({
    meta: [
      { title: "Blog — AEPL" },
      { name: "description", content: "Insights, industry updates and project stories from Aanya Engineers Private Limited." },
      { property: "og:title", content: "AEPL Blog" },
      { property: "og:description", content: "News and articles on engineering, construction, safety and sustainability." },
    ],
  }),
  component: BlogPage,
});
