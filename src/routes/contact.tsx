          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div>
              ...
              <div className="mt-10 space-y-6">
                ...
                <ContactItem
                  label="Head Office"
                  value="H.I.G.H.No. 6D/949 Sec 6, Pt. Deen Dayal Upadhyay Puram, Sikandra, Agra-282007, Uttar Pradesh, India"
                  icon={
                    <svg
                      width="18"
                      height="18"
                ...
                <ContactItem
                  ...
                  value="2nd Floor, H-107/201, Noida Sector 63, Gautambuddha Nagar, Uttar Pradesh, 201301"
                  icon={
                    <svg
                      width="18"
                      height="18"
