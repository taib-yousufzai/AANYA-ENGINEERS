        ...
        <div className="mx-4 mb-4 rounded-2xl bg-dark/95 p-6 backdrop-blur">
          {NAV.map((l) => (
            <Link
              ...
              className="block py-2.5 text-dark-foreground hover:text-primary transition-colors"
            >
              {l.label}
            </Link>
          ))}
...
export function Breadcrumb({ items }: { items: { label: string; to?: string }[] }) {
  return (
    <nav
      ...
      className="flex items-center gap-2 text-sm text-dark-foreground/60 mt-6"
    >
...
const SOCIALS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/aanyaengineers_aepl?utm_source=qr",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/aanya-engineers-pvt-ltd/",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="container-x py-16">
        <div className="grid gap-12 md:grid-cols-4">
          <div>
            ...
            <p className="mt-6 text-sm text-dark-foreground/70 leading-relaxed">
              Aanya Engineers delivers integrated engineering, manufacturing, fabrication, and
              construction solutions for Oil & Gas, Petrochemical, Power, and Industrial projects.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4 text-sm text-dark-foreground/70">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+918448389037" className="hover:text-primary transition-colors">
                  +91 8448389037
                </a>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-primary font-medium mb-0.5">Head Office</div>
                  <span>
                    H.I.G.H.No. 6D/949 Sec 6, Pt. Deen Dayal Upadhyay Puram, Sikandra, Agra-282007,
                    Uttar Pradesh, India
                  </span>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-primary font-medium mb-0.5">Corporate Office</div>
                  <span>
                    2nd Floor, H-107/201, Noida Sector 63, Gautambuddha Nagar, Uttar Pradesh, 201301
                  </span>
                </div>
              </li>
            </ul>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-dark-foreground/10 pt-6 text-xs text-dark-foreground/60 md:flex-row">
          ...
          <div className="flex gap-5">
            {SOCIALS.map((s) => (
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                {s.label}
              </a>
            ))}
          </div>
  ...
  return (
    <section className="bg-dark text-dark-foreground rounded-b-[2.5rem]">
      <div className="container-x pt-40 pb-20 text-center">
        ...
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold leading-tight md:text-6xl">
          {title}
        </h1>
        {subtitle && (
