...
export const Route = createFileRoute("/projects")({
  head: () => ({
    meta: [
      { title: "Projects — AEPL" },
      { name: "description", content: "Explore AEPL's portfolio of completed and ongoing engineering and construction projects across oil & gas, pipeline, and industrial sectors." },
      { property: "og:title", content: "Projects — AEPL" },
      { property: "og:description", content: "A track record of precision-executed projects across India's industrial landscape." },
    ],
  }),
  component: ProjectsPage,
});

const CATEGORIES = ["All", "Oil & Gas", "Pipeline", "Storage", "Shutdown", "Fire Protection"];
                ...
                <span
                  className={`absolute top-4 right-4 rounded-full px-3 py-1 text-xs font-semibold ${
                    p.status === "Ongoing"
                      ...
                      : "bg-dark/80 text-dark-foreground backdrop-blur-sm"
                  }`}
                >
                  {p.status}
                </span>
