    ...
    <section className="relative isolate min-h-[100svh] overflow-hidden">
      ...
      <div className="relative container-x flex min-h-[100svh] flex-col items-center justify-center pt-32 pb-24 text-center text-dark-foreground">
        ...
        <h1 className="max-w-5xl font-display text-5xl font-bold leading-[1.05] sm:text-6xl md:text-7xl">
          Integrated Engineering <span className="text-primary">&</span> Construction with AEPL
        </h1>
      ...
      <div className="container-x">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.slice(0, 4).map(s => (
            <article key={s.title} className="group overflow-hidden rounded-2xl bg-dark-foreground/5 ring-1 ring-dark-foreground/10 hover:ring-primary/50 transition-all hover:-translate-y-1 duration-300">
      ...
      <div className="rounded-[2rem] bg-gradient-to-br from-primary/20 via-secondary to-secondary p-10 md:p-16">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">A multidisciplinary team with expertise across the full lifecycle of industrial construction.</p>
          </div>
          ...
          <div className="flex gap-6">
            {testimonials.map(t => (
              <figure key={t.name} className="min-w-0 shrink-0 basis-full md:basis-1/2 rounded-2xl bg-dark-foreground/5 p-8 ring-1 ring-dark-foreground/10">
                ...
                <blockquote className="mt-4 text-dark-foreground/90 leading-relaxed">{t.text}</blockquote>
  ...
  return (
    <section className="container-x py-24 md:py-32">
      <div className="mx-auto max-w-3xl text-center mb-12">
        <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-primary">News &amp; Blog</p>
        <h2 className="font-display text-4xl font-bold md:text-5xl text-gradient-fade">Articles &amp; blog posts</h2>
      </div>
